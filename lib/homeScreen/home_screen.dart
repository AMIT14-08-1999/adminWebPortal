...
import 'package:admin_web_portal/sellers/block_seller_screen.dart';
import 'package:admin_web_portal/sellers/verified_sellers_screen.dart';
import 'package:admin_web_portal/users/block_users_screen.dart';
import 'package:admin_web_portal/users/verified_user_screen.dart';
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (c) => BlockedUserScreen()));
                  },
                  child: Image.asset(
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (c) => VerifiedSellerScreen()));
                  },
                  child: Image.asset(
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (c) => BlockSellerScreen()));
                  },
                  child: Image.asset(
