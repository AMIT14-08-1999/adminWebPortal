...
import 'package:admin_web_portal/sellers/sellers_pie.dart';
import 'package:admin_web_portal/users/users_pie.dart';
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (c) => const SellerPieChartScreen()));
                },
                child: const Text(
                  "Sellers PieChart",
                  style: TextStyle(
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (c) => const UsersPieChart()));
                },
                child: const Text(
                  "Users PieChart",
                  style: TextStyle(
